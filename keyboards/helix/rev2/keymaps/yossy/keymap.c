...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
      ...
      KC_LSFT,  KC_Z,    KC_X,    KC_C,             KC_V,             KC_B,  L_SPC, L_SPC, KC_N,  KC_M,             JP_COMM,          JP_DOT,  KC_UP,   JP_SLSH, \
   ...
   */
  [_LOWER] = LAYOUT( \
      KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                     JP_QUOT, JP_LPRN, JP_RPRN, _______, JP_EQL , JP_TILD, \
      JP_1,    JP_2,    JP_3,    JP_4,    JP_5,    JP_6,                      JP_7,    JP_8,    JP_9,    JP_0,    JP_MINS, JP_CIRC, \
      KC_GRV,  KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,                     KC_F6,   JP_PIPE, JP_YEN,  JP_AT,   JP_COLN,   JP_UNDS, \
      _______, _______, KC_F5,   KC_F6,   KC_F7,   ADJUST,  _______, _______, KC_F12,  _______, JP_LBRC, JP_RBRC, KC_VOLU, KC_BRMU, \
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______, _______, _______, _______, _______, AG_SWAP,                   AG_NORM, QWERTY,  _______, _______, _______, _______,\
